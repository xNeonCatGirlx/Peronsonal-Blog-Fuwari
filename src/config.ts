...
export const siteConfig: SiteConfig = {
	title: "NeonCatGirl Blog",
	subtitle: "Tech info and life of flying",
	...
	banner: {
		enable: true,
		src: "assets/images/111024784_p0.webp", // Relative to the /src directory. Relative to the /public directory if it starts with '/'
...
export const navBarConfig: NavBarConfig = {
	links: [
		...
		{
			name: "GitHub",
			url: "https://github.com/xNeonCatGirlx/blog", // Internal links should not include the base path, as it is automatically added
	...
	links: [
		{
			...
			url: "https://space.bilibili.com/311911658",
		},
		{
			name: "Steam",
			icon: "fa6-brands:steam",
			url: "https://steamcommunity.com/id/xNeonCatGirlx/",
		},
		{
			name: "GitHub",
